...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DiagnosticReport">
      <sch:assert test="count(f:extension[@url = 'http://mohcc.gov.zw/fhir/lab/StructureDefinition/report-review-state']) &lt;= 1">extension with URL = 'http://mohcc.gov.zw/fhir/lab/StructureDefinition/report-review-state': maximum cardinality of 'extension' is 1</sch:assert>
